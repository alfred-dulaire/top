      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16" ref={cardsRef}>
          {narratives.map((item) => (
            <div
              key={item.title}
              className="narrative-card backdrop-blur-lg bg-white/10 p-6 rounded-xl border border-white/20"
            >
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="backdrop-blur-lg bg-white/10 p-4 rounded-xl border border-white/20 aspect-[4/3] flex items-center justify-center">
              <img 
